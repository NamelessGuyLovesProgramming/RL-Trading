...
class ChartDataValidator:
    ...
    def sanitize_chart_data(self, data, source="unknown"):
    ...
    def validate_candle_for_chart(self, candle):
        """Public API for candle validation"""
        return self._validate_candle_for_chart(candle)

    def _validate_candle_for_chart(self, candle):
